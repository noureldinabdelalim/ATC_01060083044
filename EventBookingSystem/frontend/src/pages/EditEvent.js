...
const EditEvent = () => {
    ...
    useEffect(() => {
        ...
        const fetchEventDetails = async () => {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/event/${id}`, {
                headers: {
 ...
 const handleUpdateEvent = async (e) => {
        ...
        if (eventImage instanceof File) {
            ...
            const response = await fetch("https://api.cloudinary.com/v1_1/do4wkv0zn/image/upload", {
                method: "POST",
                body: formData,
            });
        ...
        const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/admin/event/${id}`, {
            method: "PUT",
            headers: {
     ...
     return (
        <div className="edit-event" style={{ width: "50%", margin: "0 auto", textAlign: "left" }}>
            <h2>Edit Event</h2>
            <form className="needs-validation" onSubmit={handleUpdateEvent} noValidate>
                <div className="mb-3">
...
<div className="mb-3">
    ...
    {eventImage && (
        <img
            src={eventImage instanceof File ? URL.createObjectURL(eventImage) : eventImage}
            alt="Event Preview"
